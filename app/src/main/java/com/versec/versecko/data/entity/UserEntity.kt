...
data class UserEntity(
    ...
    @ColumnInfo(name = "trip_wish") var tripWish : List<String> = listOf("-","-","-"),
    @ColumnInfo(name = "trip_style") var tripStyle : List<String> = listOf("style"),
    @ColumnInfo(name = "self_introduction") var selfIntroduction : String = "Hi",

    @ColumnInfo(name = "uri_list") var uriList : List<String> = listOf("0", "1", "2"),
